...
public class HbaseWordRepository implements IWordRepository {
	...
	/**
	 * Return a dump of the whole table. This obviously will NOT scale! It is
	 * just useful for tests.
	 * 
	...
	/**
	 * Remove all rows from the words table. Note that this probably won't scale
	 * nicely.
	 * 
	 */
	 ...
	 * 
	 * @throws RepositoryException
	 *             if the table cannot be initialized.
	 */
